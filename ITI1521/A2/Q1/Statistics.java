 ...
 * ITI1521A Assignement 2 Question 1.
...
public class Statistics {
    ...
    public String toString() {
        return( // 5 lines, decimals chopped to two decimal places.
           "We have run " + (int)numberOfRuns + " experiments.\n"
           + "The minimum was: " + minval + "\n"
           + "The maximum was: " + maxval + "\n"
           + "The mean was: " + ((int)(average*100.0))/100.0 + "\n"
